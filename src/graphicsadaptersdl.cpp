...
namespace ga
{
	...
	GraphicsAdapterSDL::GraphicsAdapterSDL( SDL_Surface* surface )
	: _surface( surface )
	{}
	...
	void GraphicsAdapterSDL::drawImage(Image_ptr img, const Rect & src, const Point & dest, bool ck, unsigned char alpha)
	{
	...
	void GraphicsAdapterSDL::drawImage(Image_ptr img, const Point & dest, bool ck, unsigned char alpha)
	{
		// Espero que no acceda a la vtable ! sino es un compilador malo malo (se porta mal)
		GraphicsAdapterSDL::drawImage( img, img->getRect(), dest, ck, alpha);
	}

	void GraphicsAdapterSDL::drawText(TextRenderer_ptr tr, const std::string txt, const Point & dest)
	{
		tr->sdl_render_text(_surface, txt, dest._x, dest._y);
	}
	
	void GraphicsAdapterSDL::drawText(TextRenderer_ptr tr, const std::wstring txt, const Point & dest)
	{
		tr->sdl_render_text(_surface, txt, dest._x, dest._y);
	}
