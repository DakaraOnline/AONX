	...
	: RendererEngine()
{
    ...
    */
	...
	flags = SDL_OPENGL;// | SDL_FULLSCREEN; // | SDL_HWSURFACE | SDL_FULLSCREEN;
	...
	RendererEngine::initializeGA( ga::GraphicsAdapter_ptr( new ga::GraphicsAdapterOGL ( _screen, guichan ) ) );
...
void RendererEngineOGL::renderTecho( ao::MapTile & tile, Offset basePixel )
{
